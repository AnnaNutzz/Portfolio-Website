            ...
            {sections.map(({ id, label }) => {
                ...
                return (
                    <button
                        ...
                        className={`group flex items-center justify-end transition-all duration-300 ease-in-out ${
                            isActive ? "opacity-100" : "opacity-40 hover:opacity-100"
                        }`}
                        aria-label={`Scroll to ${label}`}
                    >
                        <span 
                            className={`mr-2 md:mr-3 transition-all duration-300 font-medium whitespace-nowrap drop-shadow-md ${
                                isActive 
